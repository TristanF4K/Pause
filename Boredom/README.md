...
**Hinweis**: Diese App verwendet Apple's Screen Time API, die Nutzer jederzeit in den Einstellungen deaktivieren können. FocusLock ist ein Tool zur Selbstkontrolle, keine absolute Sperre.
